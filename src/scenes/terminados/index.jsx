...
const Terminados = ({ notes, setNotes }) => {
	...
	return (
		<Box m="20px">
			...
			>
				<Header
					title="Notas Terminadas"
					subtitle="Aquí podrás encontrar todas tus notas categorizadas como terminadas "
				/>
			</Box>
			{/* Notes*/}
			<Grid container rowSpacing={2} columnSpacing={{ xs: 1, sm: 2, md: 2 }}>
				{notes
					.filter((note) => note.category == 'terminado')
					.map((note) => {
						return (
